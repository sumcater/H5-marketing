    ...
    <div class="box" id="box">
      ...
      <div class="paw">
        <div class="chuanglian">
          <img src="./images/chuanglian.png" alt />
        </div>
        <div class="pawer"></div>
        <div class="pawerPic">
      ...
      <div class="area">
        ...
        <div id="pack1" class="pack">
          <div id="sel1">
            <img src="./images/mks.png" tr="1" />
            <img src="./images/mks.png" tr="2" />
          </div>
          <div id="sel2"></div>
        </div>
      ...
      <div class="btn">
        <!--点击前-->
        <div class="btn_star" @click="start"></div>
  ...
  mounted() {
    ...
    function changeRem() {
      ...
      document
        ...
        .style.setProperty(
          "--height",
          (document.documentElement.clientWidth * 812) / 375 + "px"
        );
    }

    // 页面宽度
    this.winWidth = $(window).width();
    console.log($(".chuanglian").height(), "99");
    // 活动区域的高
    this.areaHeight = this.screenHeight * 0.8 - $(".chuanglian").height();
    // 爪子伸长的距离(目前娃娃的高度暂定为115px;)
    this.long = this.areaHeight - $("#sel3").height() * 1.5;
    /* 赋值给活动区域高度 */
...
.box {
  width: 100%;
  height: 100%;
  background: url(./images/zwwbj.png) no-repeat center;
...
.paw {
  ...
  width: 93%;
  // height: 77px;
  // // background: url(./images/chuanjian.png) no-repeat center;
  // background-size: cover;
  position: relative;
}
.chuanglian {
...
.pawer {
  width: 17px;
  background: url(./images/zhuzi.png) no-repeat center;
  background-size: cover;
  height: 20px;
  position: absolute;
  top: 60px;
...
.btn {
  ...
  position: absolute;
  bottom: 0;
  background: url(./images/optBtn.png);
  background-size: cover;
  display: flex;
  justify-content: center;
}
...
#pack2 {
  ...
  bottom: 0;
  left: 3.5%;
  background: url(./images/kuadao.png) no-repeat center;
  background-size: contain;
